...
class MoveitServer {
public:
  MoveitServer(const rclcpp::Node::SharedPtr& node)
  : node_(node)
  {
    ...
    service_ = node_->create_service<helper::srv::MoveRequest>(
      "/moveit_path_plan",
  ...
  void handle_request(
    const std::shared_ptr<helper::srv::MoveRequest::Request> request,
